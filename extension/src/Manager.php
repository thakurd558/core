...
class Manager {
    ...
    public function isInstalled(string $name) : bool {
        $extension = $this->getAvailableExtensions()->findByName($name);
...
//		}
        ...
        if ( ! isset($this->routes[$name])) {
            ...
            $this->routes[$name] = $app->make(RouteGenerator::class, [
                $app->make('config')->get($key, $default),
                $app->make('request'),
            ]);
        }
    ...
    public function getActiveExtensionByPath(string $name) : string {
        $extension = $this->getAvailableExtensions()->filterByActivated()->findByName($name);
