...
class Extensions extends Collection {
    ...
    public function findByName(string $name) {
        return $this->first(function($key, ExtensionContract $extension) use($name) {
    ...
    public function findByVendorAndName(string $vendor, string $name) {
        ...
        return $this->first(function($key, ExtensionContract $extension) use($fullName) {
    ...
    public function findByPath(string $path) {
        return $this->first(function($key, ExtensionContract $extension) use($path) {
